...
namespace Bislerium_cafe
{
    public partial class Addin : Form
    {
        ...
        {
            string excelPath = "C:\\Users\\Nisch\\OneDrive\\Desktop\\3rd year\\Coursework\\Application Development\\staff_login_data.xlsx";
                ...
                for (int row = 2; row <= rowCount; row++)
                {
                   ...
                   Panel  mainPanel = new Panel
                    ...
                    PictureBox userphoto = new PictureBox()
                    {
                        ...
                        Image = Image.FromFile("C:\\Users\\Nisch\\source\\repos\\Bislerium cafe\\photo\\coffee.png"),
